...
def split_nb_name(fn):
    re_parts = [re.compile(r'[A-Z]+_'),  # module name
                re.compile(r'\d+[-_]'),  # module number
...
def build_nb_name(m_name, m_number, f_number, f_name, f_ext):
    ...
    # Check and correct module numer. It must end with a -
...
class CourseGenerator:
    ...
    def __init__(self):
        ...
        self.p_dict = {
            ...
            'title': None,
            'subtitle': None,
            'title_background': 'GSObackgroundTitle',
        ...
        self.contents = {
            ...
            'LinearRegression': ('02', ('ML_LinReg',)),
            'LinReg': ('02', ('ML_LinReg',)),
            'LogisticRegression': ('02', ('ML_LogReg',)),
            'LogReg': ('02', ('ML_LogReg',)),
            'kNN': ('03', ('ML_kNN',)),
            'DTree': ('04', ('ML_DTree',)),
            'Evaluation': ('05', ('ML_Evaluation', )),
            'DimReduction': ('06', ('ML_FeatureSelection', 'ML_FeatureExtraction', 'ML_FeatureVisualization')),
            'BayesDA': ('07', ('ML_Bayes', )),
            'SVM': ('11', ('ML_SVM',)),
            'Cluster': ('12', ('ML_Cluster',)),
            'TimeSeries': ('13', (
            'DA_TimeSeries1', 'DA_Fourier', 'DA_TSDecomposition', 'DA_TSAR', 'DA_TSMA', 'DA_TSARMA', 'DA_TSARIMA')),
            'NN': ('15', (
            'ML_NN_Perceptron', 'ML_NN_Activation', 'ML_NN_Loss', 'ML_NN_PerceptronRegression', 'ML_NN_TFKeras',
            'ML_NN_Learning', 'ML_MLP', 'ML_NN_TimeSeries')),
            'DLIntro': ('21', ('ML_DLIntro',)),
            'CNNBasics': (
            '22', ('ML_CNN_BasicElements', 'ML_CNN_Basics_Conv', 'ML_CNN_Basics_Pooling', 'ML_CNN_Basics_Example')),
